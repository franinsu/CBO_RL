...
nohup python3 ./cloud_script.py continuous resnet 0 0 1 0 0 150 150 10 90 1 > out1.log &
nohup python3 ./cloud_script.py discrete tabular 0 0 1 0 0 150 150 10 90 1 > out2.log &
